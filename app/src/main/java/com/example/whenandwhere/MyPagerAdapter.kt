...
class MyPagerAdapter(fragmentActivity: FragmentActivity, private val dataList: List<MyData>, private val scheduleList: List<ScheduleDto>) : FragmentStateAdapter(fragmentActivity) {
